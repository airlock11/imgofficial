...
async function handleRequest(request) {
  const env = {
    BALLDONTLIE_API_KEY: typeof BALLDONTLIE_API_KEY !== "undefined" ? BALLDONTLIE_API_KEY : undefined,
    SPORTSAPI_KEY: typeof SPORTSAPI_KEY !== "undefined" ? SPORTSAPI_KEY : undefined,
    BOXING_DATA_API_KEY: typeof BOXING_DATA_API_KEY !== "undefined" ? BOXING_DATA_API_KEY : undefined,
    YOUTUBE_API_KEY: typeof YOUTUBE_API_KEY !== "undefined" ? YOUTUBE_API_KEY : undefined,
    YOUTUBE_ALLOWED_CHANNEL_IDS: typeof YOUTUBE_ALLOWED_CHANNEL_IDS !== "undefined" ? YOUTUBE_ALLOWED_CHANNEL_IDS : undefined,
    FACEBOOK_ACCESS_TOKEN: typeof FACEBOOK_ACCESS_TOKEN !== "undefined" ? FACEBOOK_ACCESS_TOKEN : undefined,
    FACEBOOK_PAGE_IDS: typeof FACEBOOK_PAGE_IDS !== "undefined" ? FACEBOOK_PAGE_IDS : undefined,
    FACEBOOK_GRAPH_VERSION: typeof FACEBOOK_GRAPH_VERSION !== "undefined" ? FACEBOOK_GRAPH_VERSION : undefined,
    STREAM_SOURCES_JSON: typeof STREAM_SOURCES_JSON !== "undefined" ? STREAM_SOURCES_JSON : undefined,
  };
...
function streamLeagueForSport(sport) {
  const map = {
    ...
    ipl: { label: "IPL Cricket", youtube: [], youtubeHandles: ["IPL"] },
    volleyball_w: { label: "FIVB Women", youtube: [], youtubeHandles: ["VolleyballWorld"] },
    volleyball_m: { label: "FIVB Men", youtube: [], youtubeHandles: ["VolleyballWorld"] },
